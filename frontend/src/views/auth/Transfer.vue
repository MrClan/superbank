                    ...
                    <div class="flex flex-wrap">
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <select v-model="selectedSourceAccount">
                            <option
                              v-for="a in accounts"
                              :key="a.id"
                      ...
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <select v-model="selectedTargetAccount">
                            <option
                              v-for="a in accounts"
                              :key="a.id"
                              v-bind:value="a.accountNo"
    ...
    withdraw() {
      apiHandler
        .post("/transactions/transfer", {
          srcAccountNo: this.selectedSourceAccount,
          targetAccountNo: this.selectedTargetAccount,
          amount: this.amount,
